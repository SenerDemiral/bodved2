...
set TOOLS_PATH=packages\Grpc.Tools.1.17.1\tools\windows_x64
...
%TOOLS_PATH%\protoc.exe --csharp_out RestLib --grpc_out RestLib protos/CRUD.proto --plugin=protoc-gen-grpc=%TOOLS_PATH%\grpc_csharp_plugin.exe
