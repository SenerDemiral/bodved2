...
/*
        ...
        public static void RefreshDonemRank22222(int DnmRun)
        {
            Stopwatch watch = new Stopwatch();
            watch.Start();
            int nor = 0;
        ...
        public static void RefreshDonemRank(int DnmRun)
        {
            Stopwatch watch = new Stopwatch();
            watch.Start();
            int nor = 0;
        ...
        public static void RefreshGlobalRank(DateTime trh)  // Kullanilmiyor
        {
